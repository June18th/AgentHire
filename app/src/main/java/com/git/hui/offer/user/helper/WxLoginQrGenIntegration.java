...
import com.git.hui.offer.constants.user.LoginQrTypeEnum;
...
public class WxLoginQrGenIntegration {
    ...
    private static final String WX_TOKEN_URL = "https://api.weixin.qq.com/cgi-bin/token?grant_type={grant_type}&appid={appid}&secret={secret}";
    ...
    private synchronized void refreshAccessToken() {
        WxAccessToken token = HttpRequestHelper.get(WX_TOKEN_URL,
                Map.of("grant_type", "client_credential",
    ...
    private String genServiceAccountLoginQrCode(String code) {
        ...
        if (url != null) {
            ...
            Map<String, Object> params = Map.of(
                    ...
                    "action_info", Map.of("scene", Map.of("scene_id", code, "scene_str", "paiLogin#" + code)));
