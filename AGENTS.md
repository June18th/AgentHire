...
- 新架构参考`docs/jobclaw.md`
- 新增模块: `core/`、`channels/`、`providers/`、`plugins/`
- 原有`app/`目录正在逐步迁移

### 配置文件

- 开发配置: `app/src/main/resources-env/dev/`
- 测试配置: `app/src/main/resources-env/test/`
- 生产配置: `app/src/main/resources-env/prod/`

### 数据库

- dev环境: H2内存数据库 (`ai-oc.mv.db`)
- test/prod环境: MySQL
