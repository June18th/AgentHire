...
import com.git.hui.jobclaw.components.cache.PlatformCacheService;
...
public class LoginService {
    ...
    public int incrOnlineUserCnt(int add) {
        return platformCacheService.incrOnlineUserCnt(add);
    }
    ...
    public int getOnlineUserCnt() {
        return platformCacheService.getOnlineUserCnt();
    }
}
