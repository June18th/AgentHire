...
public class SmartWebFetchTool implements AutoCloseable {
    ...
    private final boolean summaryEnable;
    ...
    public String webFetch(@ToolParam(description = "The URL to fetch content from") String url,
        ...
        String summary;
        if (summaryEnable) {
            summary = this.summarize(mdContent, prompt);
        } else {
            summary = mdContent;
        }
        // Cache the content
    ...
    public static class Builder {
        ...
        public Builder summaryEnable(boolean summaryEnable) {
            this.summaryEnable = summaryEnable;
            return this;
        }
        ...
        public SmartWebFetchTool build() {
            return new SmartWebFetchTool(this.chatClient, this.maxContentLength, this.domainSafetyCheck,
                    this.maxCacheSize, this.failOpenOnSafetyCheckError, this.maxRetries, this.summaryEnable);
        }
