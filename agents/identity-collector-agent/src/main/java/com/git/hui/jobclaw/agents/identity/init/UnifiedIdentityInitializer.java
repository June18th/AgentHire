...
public class UnifiedIdentityInitializer {
     ...
     */
    public boolean checkAndAdvance(Agent.UserConversationInfo conversationInfo, String userMessage) {
    ...
    private boolean handleSoulCollection(UnifiedCollectionState state,
                                         Agent.UserConversationInfo conversationInfo,
                                         String userMessage) {
     ...
     */
    private boolean handleUserIdentityCollection(UnifiedCollectionState state, Agent.UserConversationInfo conversationInfo,
                                                 String userMessage) {
     ...
     */
    private boolean handleInfoGeneration(UnifiedCollectionState state, Agent.UserConversationInfo userConversationInfo) {
