这一篇将以智谱清言大模型为例，介绍校招派是如何借助SpringAI来进行 AI 应用开发的。



<!-- 这是一张图片，ocr 内容为：SPRINGAI LLM OUT IN CALL/RESPONSE QUERY/RESULT READ/WRITE MEMORY TOOLS RETRIEVAL -->
![](https://cdn.nlark.com/yuque/0/2025/png/12564477/1758335723638-8d096c89-5c91-4d79-9dcc-98b2ed28ac06.png)

# 一、前置准备
## 1.申请ApiKey
到大模型后台进行申请，智谱的申请请看 [✅校招派大模型-智普清言接入](https://www.yuque.com/itwanger/yyt72l/bkb31aukyil47osx)  

星火大模型接入的请看 [校招派大模型-星火SparkLite接入](https://www.yuque.com/itwanger/yyt72l/mk1l8vauyvtw13kw)
...
+ 文本模型：<font style="color:#000000;background-color:#c7edcc;">GLM-4-Flash</font>
+ 图片模型：<font style="color:#000000;background-color:#c7edcc;">GLM-4V-Flash</font>
...
# 三、小结
本文主要介绍了校招派集成 SpringAI，整体实现比较简单，需要特殊说一下的是，并不是所有的大模型，都有直接可用的 `starter`，对于没有的，需要我们按照SpringAI的规范进行扩展。
