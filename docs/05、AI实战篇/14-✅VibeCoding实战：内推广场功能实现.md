在校招派的项目根目录下有一个名为 `AGENTS.md`的文件，其主要作用就是给AI IDE使用的，指导AI怎么进行开发；
...
[校招派-VibeCoding实现内推广场_高清1080P在线观看平台_腾讯视频](https://v.qq.com/x/page/u3176lyk7pa.html)

# 三、小结
VibeCoding 在今年一直都挺火的，网上相关的资料也不算少，我们这里演示了一下校招派借助VibeCoding来实现需求开发的过程，整体看下来，提效还是很明显的；整个内推广场，如果需要我们自己来coding，最少也是半天的工作量，而VibeCoding，则直接压缩到半小时，属实是有些夸张了
...
:::color2
郑重声明，由于我本人并不是深度的VibeCoding从业人员，以上的提示词只是摸索过程的产物，因此这个提示词，<font style="color:#DF2A3F;">并不代表最佳实践或者最优解</font>，只是一个给大家参照的示例，请在实际使用的过程中，根据自己的感觉来调整、修正和补充
